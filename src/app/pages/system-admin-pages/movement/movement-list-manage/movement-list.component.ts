...
export class MovementListComponent implements OnInit {
  ...
  get f() {
    return this.createMovementForm.controls;
  }

  get movementCategoryIdRequest() {
    return this.movementCategoryRequestForm.controls;
  }

  getMovements(categoryId: number = 0) {
    console.log(categoryId);
    this.movementService
      .getMovements(categoryId, this.page, this.pageSize)
      .subscribe((res) => {
